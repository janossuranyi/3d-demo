...
public:
	...
	void set(const std::string& name, const glm::ivec2& i) const;
	void set(const std::string& name, const glm::vec2& i) const;
	void set(const std::string& name, int i) const;
	void set(const std::string& name, float i) const;
	void use() const;
