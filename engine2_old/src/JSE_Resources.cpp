...
std::unordered_map<std::string, std::string> js::Filesystem::resource_map_;
std::set<std::string> js::Filesystem::sources_;
...
namespace js {
    ...
    bool Filesystem::add_resource_path(const std::string& path)
    {
    ...
    std::string Filesystem::get_text_resource(const std::string& name)
    {
    ...
    std::string Filesystem::get_text_resource_with_includes(const std::string& name, int depth)
    {
    ...
    std::vector<unsigned char> Filesystem::get_binary_resource(const std::string& name)
    {
    ...
    std::string Filesystem::get_resource(const std::string& name)
    {
        if (resource_map_.count(name) == 0) return "";
