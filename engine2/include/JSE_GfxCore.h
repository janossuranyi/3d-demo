...
// alpha mode
enum class JseAlphaMode { Opaque, Mask, Blend };
...
enum JseShaderStageFlags {
    JSE_STAGE_FLAG_VERTEX = 1<<0,
    JSE_STAGE_FLAG_FRAGMENT = 1<<1,
    JSE_STAGE_FLAG_GEOMETRY = 1<<2,
    JSE_STAGE_FLAG_TESSELATION_CONTROL = 1<<3,
    JSE_STAGE_FLAG_TESSELATION = 1<<4,
    JSE_STAGE_FLAG_COMPUTE = 1<<5,
    JSE_STAGE_FLAG_ALL = ~0
};
