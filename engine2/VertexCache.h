...
#define JSE_VERTEX_CACHE_OFFSET_BITS	27
#define JSE_VERTEX_CACHE_SIZE_BITS		24	// 16MB
...
#define JSE_VERTEX_CACHE_SIZE_SHIFT		28
#define JSE_VERTEX_CACHE_FRAME_SHIFT	52

#define JSE_VERTEX_CACHE_OFFSET_MASK	((1ULL << JSE_VERTEX_CACHE_OFFSET_BITS) - 1)
#define JSE_VERTEX_CACHE_SIZE_MASK		((1ULL << JSE_VERTEX_CACHE_SIZE_BITS) - 1)
#define JSE_VERTEX_CACHE_FRAME_MASK		((1ULL << JSE_VERTEX_CACHE_FRAME_BITS) - 1)
